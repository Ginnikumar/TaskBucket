...
var author$project$Main$Comment = F5(
	function (commentId, taskId, text, createdBy, createTime) {
		return {commentId: commentId, createTime: createTime, createdBy: createdBy, taskId: taskId, text: text};
	});
...
var author$project$Main$emptyModel = {
	...
	loginUser: author$project$Main$emptyLoginUser,
...
var author$project$Main$CancelFilter = {$: 'CancelFilter'};
var author$project$Main$CommentCreated = function (a) {
...
var author$project$Main$createCommentEncoder = F3(
	function (user, task, comment) {
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'task_id',
					elm$json$Json$Encode$int(task.taskId)),
					_Utils_Tuple2(
					'text',
...
var author$project$Main$createCommentRequest = F3(
	function (user, task, comment) {
...
var author$project$Main$newTaskEncoder = function (task) {
	var _n0 = A2(elm$core$Debug$log, 'task===', task);
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
				'status',
				elm$json$Json$Encode$int(task.status)),
				_Utils_Tuple2(
				'due_date',
				elm$json$Json$Encode$string(task.due_date))
			]));
};
...
var author$project$Main$createTaskRequest = function (task) {
	return elm$http$Http$post(
		{
			body: elm$http$Http$jsonBody(
...
var author$project$Main$TaskDeleted = function (a) {
	return {$: 'TaskDeleted', a: a};
};
var author$project$Main$Message = function (message) {
	return {message: message};
};
var author$project$Main$deleteMessageDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'message',
	elm$json$Json$Decode$string,
...
var author$project$Main$deleteTaskRequest = function (task) {
	return elm$http$Http$post(
		{
			body: elm$http$Http$jsonBody(
...
var author$project$Main$User = F4(
	function (id, name, email, imageurl) {
		return {email: email, id: id, imageurl: imageurl, name: name};
	});
...
var author$project$Main$logInUserEncoder = function (loginUser) {
	var _n0 = A2(elm$core$Debug$log, 'loginUser===', loginUser);
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var author$project$Main$updateTaskRequest = function (task) {
	var _n0 = A2(elm$core$Debug$log, 'task in updateTaskRequest ===', task);
	return elm$http$Http$post(
		{
			body: elm$http$Http$jsonBody(
				author$project$Main$newTaskEncoder(task)),
	...
	function (msg, model) {
		switch (msg.$) {
			case 'AddTask':
				return _Utils_Tuple2(
					model,
					author$project$Main$createTaskRequest(model.newTask));
			case 'CreateTask':
				var _n1 = A2(elm$core$Debug$log, 'newTask==', model.newTask);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{newTask: author$project$Main$emptyTask, renderView: 'CreateTask', tempCreatTaskOwnerName: ''}),
					elm$core$Platform$Cmd$none);
			case 'UpdateTask':
				var _n2 = A2(elm$core$Debug$log, 'UpdateTask ==', model.newTask);
				return _Utils_Tuple2(
					model,
					author$project$Main$updateTaskRequest(model.newTask));
			case 'ShowFilterPanel':
				var _n3 = A2(elm$core$Debug$log, 'showFilterPanel==', '');
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'InputTaskTitle':
				...
				var newTask = _Utils_update(
					task,
					{created_by: model.user.id, title: title});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{newTask: newTask}),
			...
			case 'InputDescription':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{newTask: newTask}),
					elm$core$Platform$Cmd$none);
			case 'SetCreateTaskOwner':
				var owner = msg.a;
				var task = model.newTask;
				var newTask = _Utils_update(
					task,
					{ownerId: owner.id});
				var _n4 = A2(elm$core$Debug$log, 'SetCreateTaskOwnerId ===', owner.name);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{newTask: newTask, tempCreatTaskOwnerName: owner.name}),
					elm$core$Platform$Cmd$none);
			...
			case 'UpdateTaskStatus':
				...
				var newTask = _Utils_update(
					task,
					{status: status});
				var _n5 = A2(elm$core$Debug$log, 'UpdateTaskStatus; newTask values ==', model.newTask);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{newTask: newTask}),
			...
			case 'CancelTask':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{newTask: author$project$Main$emptyTask, renderView: 'Dashboard'}),
					elm$core$Platform$Cmd$none);
			case 'DeleteTask':
				var taskToBeDeleted = msg.a;
				var taskList = A2(
					elm$core$List$filter,
					function (task) {
						return !_Utils_eq(task.taskId, taskToBeDeleted.taskId);
					},
					model.taskList);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{filteredTaskList: taskList, taskCount: model.taskCount, taskList: taskList}),
					author$project$Main$deleteTaskRequest(taskToBeDeleted));
			case 'ShowEditTaskPanel':
				var taskToBeEdited = msg.a;
				var taskOwnerName = A2(author$project$Main$getUserName, model.userList, taskToBeEdited.ownerId);
				var newTask = taskToBeEdited;
				var taskToBeUpdated = _Utils_update(
					newTask,
					{taskId: taskToBeEdited.taskId});
				var _n6 = A2(elm$core$Debug$log, 'ShowEditTaskPanel==', model.newTask);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{newTask: taskToBeUpdated, renderView: 'ShowEditTaskPanel', tempCreatTaskOwnerName: taskOwnerName}),
					elm$core$Platform$Cmd$none);
			case 'MarkItCompleted':
				var id = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							taskList: A2(
								elm$core$List$map,
								function (task) {
									return _Utils_eq(task.taskId, id) ? _Utils_update(
										task,
										{isTaskCompleted: !task.isTaskCompleted}) : task;
								},
								model.taskList)
						}),
					elm$core$Platform$Cmd$none);
			case 'SwitchVisibility':
				...
				var _n7 = A2(elm$core$Debug$log, 'SwitchVisibility', visibility);
				return _Utils_Tuple2(
					_Utils_update(
						model,
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						...
						A2(
							elm$core$Task$perform,
							function (_n8) {
								return author$project$Main$CancelFilter;
							},
							elm$core$Task$succeed(_Utils_Tuple0)));
				} else {
					var err = msg.a.a;
					var _n9 = A2(elm$core$Debug$log, 'Error TaskCreated==', err);
			...
			case 'TaskUpdated':
				if (msg.a.$ === 'Ok') {
					...
					var taskList = A2(
						elm$core$List$map,
						function (t) {
							return _Utils_eq(t.taskId, task.taskId) ? task : t;
						},
						model.taskList);
					var _n10 = A2(elm$core$Debug$log, 'TaskUpdated Ok; model.taskList==', task);
					var _n11 = A2(elm$core$Debug$log, 'TaskUpdated Ok; model.taskList==', model.taskList);
					var _n12 = A2(elm$core$Debug$log, 'TaskUpdated Ok;       taskList==', taskList);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{newTask: author$project$Main$emptyTask, renderView: 'Dashboard', taskList: taskList}),
						A2(
							elm$core$Task$perform,
							function (_n13) {
								return author$project$Main$CancelFilter;
					...
					var err = msg.a.a;
					var _n14 = A2(elm$core$Debug$log, 'Error TaskUpdated==', err);
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'TaskDeleted':
				if (msg.a.$ === 'Ok') {
			...
			case 'TasksFetched':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{filteredTaskList: tasks, taskList: tasks}),
						elm$core$Platform$Cmd$none);
				} else {
					var err = msg.a.a;
					var _n16 = A2(elm$core$Debug$log, 'Error task fecthed===', err);
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'AddComment':
				var comment = msg.a;
				...
				return _Utils_Tuple2(
					model,
					A3(author$project$Main$createCommentRequest, model.user, task, comment));
			case 'CommentsFetched':
				if (msg.a.$ === 'Ok') {
					...
					var err = msg.a.a;
					var _n17 = A2(elm$core$Debug$log, 'Error CommentsFetched fecthed===', err);
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'CreateComment':
				var task = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{newTask: task, renderView: 'CreateComment'}),
					elm$core$Platform$Cmd$none);
			case 'CommentCreated':
				if (msg.a.$ === 'Ok') {
					var comment = msg.a.a;
					var _n18 = A2(elm$core$Debug$log, 'Ok comment : ', comment);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{renderView: 'Dashboard'}),
					...
					var err = msg.a.a;
					var _n19 = A2(elm$core$Debug$log, 'Error CommentCreated fecthed===', err);
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'InputCommentText':
				var description = msg.a;
			...
			case 'UsersFetched':
				if (msg.a.$ === 'Ok') {
					...
					var err = msg.a.a;
					var _n20 = A2(elm$core$Debug$log, 'Error users fecthed===', err);
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'InputFilterDueDate':
				var due_date = msg.a;
				var filterValues = model.filterValues;
				var filterValuesUpdated = _Utils_update(
					filterValues,
					{due_date: due_date});
				var _n21 = A2(elm$core$Debug$log, 'InputFilterDueDate ===', due_date);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{filterValues: filterValuesUpdated}),
					elm$core$Platform$Cmd$none);
			case 'InputFilterCreateDate':
				var create_date = msg.a;
				var filterValues = model.filterValues;
				var filterValuesUpdated = _Utils_update(
					filterValues,
					{create_date: create_date});
				var _n22 = A2(elm$core$Debug$log, 'InputFilterCreateDate ===', create_date);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{filterValues: filterValuesUpdated}),
			...
			case 'InputFilterLastCommentDate':
				...
				var _n23 = A2(elm$core$Debug$log, 'InputFilterLastCommentDate ===', last_comment_date);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{filterValues: filterValuesUpdated}),
			...
			case 'InputFilterTitleSearchText':
				...
				var _n24 = A2(elm$core$Debug$log, 'InputFilterTitleSearchText ===', searchText);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{filterValues: filterValuesUpdated}),
					elm$core$Platform$Cmd$none);
			case 'ApplyFilter':
				var tempFilteredTaskList = (model.filterValues.due_date === '') ? model.taskList : A2(
					elm$core$List$filter,
					function (task) {
						return _Utils_eq(task.due_date, model.filterValues.due_date);
					},
					model.taskList);
				...
				var temp1FilteredTaskList = (model.filterValues.titleSearchText === '') ? tempFilteredTaskList : A2(
					...
					function (task) {
						return A2(
							...
							elm$core$String$toLower(model.filterValues.titleSearchText),
				...
				var _n25 = elm$core$Debug$log('ApplyFilter ===');
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					elm$core$Platform$Cmd$none);
			case 'CancelFilter':
				var _n26 = A2(elm$core$Debug$log, 'CancelFilter ===', '');
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'FilterCreatorRecord':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{filterValues: newfilterValues}),
					elm$core$Platform$Cmd$none);
			case 'ToggleOwnerFilterDropdown':
				var oldfilterValues = model.filterValues;
			...
			case 'EnterUseEmail':
				...
				var updatedLoginUser = _Utils_update(
					loginUser,
					{userEmail: userEmail});
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'Login':
				return _Utils_Tuple2(
					model,
					author$project$Main$logInUserRequest(model.loginUser));
			case 'UserLoggedIn':
				if (msg.a.$ === 'Ok') {
					var user = msg.a.a;
					return _Utils_Tuple2(
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{loginUser: author$project$Main$emptyLoginUser, user: author$project$Main$emptyUser}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$Main$CreateTask = {$: 'CreateTask'};
var author$project$Main$LogOut = {$: 'LogOut'};
var author$project$Main$ShowFilterPanel = {$: 'ShowFilterPanel'};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$src('/assets/WTM_logo.jpg'),
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('taskBucket')
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Task Bucket')
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onInput(author$project$Main$EnterUserPassword),
								elm$html$Html$Attributes$type_('password'),
								elm$html$Html$Attributes$value(model.loginUser.userPassword)
							]),
						_List_Nil)
					])),
				A2(
...
var author$project$Main$SetCreateTaskOwner = function (a) {
	return {$: 'SetCreateTaskOwner', a: a};
};
...
var author$project$Main$renderCreateTaskOwnerDropdown = function (model) {
	var dropDownClass = 'dropdown-select';
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('dropDownClass textareaBtn')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('selectedOwner')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(model.tempCreatTaskOwnerName)
					])),
				A2(
				elm$html$Html$ul,
				_List_fromArray(
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									author$project$Main$SetCreateTaskOwner(x)),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Create New Task')
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Want to track a task? Add here!')
							])),
						A2(
						elm$html$Html$input,
						_List_fromArray(
				...
				author$project$Main$renderCreateTaskOwnerDropdown(model),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$CancelTask)
							]),
						_List_fromArray(
							[
...
var author$project$Main$SwitchVisibility = function (a) {
	return {$: 'SwitchVisibility', a: a};
};
var author$project$Main$keep = F2(
	function (visibility, taskList) {
		switch (visibility) {
			case 'New':
				return A2(
					elm$core$List$filter,
				...
				[
					...
					_List_fromArray(
						[
							...
							elm$html$Html$Attributes$name('visibilty-check'),
...
var author$project$Main$ShowEditTaskPanel = function (a) {
	return {$: 'ShowEditTaskPanel', a: a};
};
...
var author$project$Main$getUserImgUrl = F2(
	function (users, id) {
		var user = A2(
			elm$core$Maybe$withDefault,
			author$project$Main$emptyUser,
			elm$core$List$head(
				A2(
					...
					users)));
		var _n0 = A2(elm$core$Debug$log, 'userlist ========', users);
													...
													[
														...
														_List_fromArray(
															[
																...
																A2(author$project$Main$getUserImgUrl, userList, comment.createdBy)),
														...
														_List_fromArray(
															[
																elm$html$Html$text(comment.createTime)
															]))
													]))
											]))
									]))
...
var author$project$Main$renderDashboard = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('main-panel')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						'All',
						author$project$Main$SwitchVisibility('All'),
						(model.visibility === 'All') ? true : false),
						A3(
						author$project$Main$radio,
						'New',
						author$project$Main$SwitchVisibility('New'),
						...
						author$project$Main$radio,
						'Completed',
						author$project$Main$SwitchVisibility('Completed'),
						(model.visibility === 'Completed') ? true : false),
						A3(
						author$project$Main$radio,
						'Cancelled',
						author$project$Main$SwitchVisibility('Cancelled'),
						(model.visibility === 'Cancelled') ? true : false)
					])),
				A2(
				author$project$Main$renderList,
				A2(author$project$Main$keep, model.visibility, model.filteredTaskList),
				model)
			]));
};
var author$project$Main$ApplyFilter = {$: 'ApplyFilter'};
var author$project$Main$InputFilterCreateDate = function (a) {
	return {$: 'InputFilterCreateDate', a: a};
};
...
var author$project$Main$ToggleOwnerFilterDropdown = {$: 'ToggleOwnerFilterDropdown'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$ToggleOwnerFilterDropdown),
						elm$html$Html$Attributes$class('selectedoption button'),
						elm$html$Html$Attributes$id('orgnode_dd')
					]),
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onInput(author$project$Main$InputFilterTitleSearchText),
								elm$html$Html$Attributes$value(model.filterValues.titleSearchText)
							]),
						_List_Nil)
					])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('primary'),
								elm$html$Html$Events$onClick(author$project$Main$ApplyFilter)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$CancelFilter)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Cancel')
...
var author$project$Main$UpdateTask = {$: 'UpdateTask'};
var author$project$Main$UpdateTaskStatus = function (a) {
	return {$: 'UpdateTaskStatus', a: a};
};
var author$project$Main$renderShowEditTaskPanelView = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('filter1')
					]),
				_List_fromArray(
					[
						A3(
						author$project$Main$radio,
						'New',
						author$project$Main$UpdateTaskStatus(0),
						(!model.newTask.status) ? true : false),
						A3(
						author$project$Main$radio,
						'In-Progress',
						author$project$Main$UpdateTaskStatus(1),
						(model.newTask.status === 1) ? true : false),
						A3(
						author$project$Main$radio,
						'Completed',
						author$project$Main$UpdateTaskStatus(2),
						(model.newTask.status === 2) ? true : false),
						A3(
						author$project$Main$radio,
						'Cancelled',
						author$project$Main$UpdateTaskStatus(3),
						(model.newTask.status === 3) ? true : false)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('primary'),
								elm$html$Html$Events$onClick(author$project$Main$UpdateTask)
							]),
						_List_fromArray(
							[
...
var author$project$Main$view = function (model) {
	...
	var isUserNotLoggedIn = _Utils_eq(model.user, author$project$Main$emptyUser);
	return isUserNotLoggedIn ? author$project$Main$loginView(model) : A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						(model.renderView === 'ShowEditTaskPanel') ? A2(
						elm$html$Html$div,
						_List_fromArray(
							[
								elm$html$Html$Attributes$classList(
						...
						_List_fromArray(
							[
								author$project$Main$renderShowEditTaskPanelView(model)
							])) : elm$html$Html$text(''),
						(model.renderView === 'FilterTasks') ? A2(
						elm$html$Html$div,
						_List_fromArray(
							[
								elm$html$Html$Attributes$classList(
						...
						_List_fromArray(
							[
								author$project$Main$renderFilterView(model)
							])) : elm$html$Html$text('')
					]))
			]));
};
							...
							function (userList) {
								return A2(
									...
									function (user) {
										return A2(
											elm$json$Json$Decode$andThen,
											function (tempCreatTaskOwnerName) {
												return A2(
													elm$json$Json$Decode$andThen,
													function (taskList) {
														return A2(
															...
															function (taskCount) {
																return A2(
																				...
																				return A2(
																												...
																												return A2(
																													...
																													function (commentList) {
																														return elm$json$Json$Decode$succeed(
																															{commentList: commentList, currentComment: currentComment, filterValues: filterValues, filteredTaskList: filteredTaskList, loginUser: loginUser, newTask: newTask, renderView: renderView, taskCount: taskCount, taskList: taskList, tempCreatTaskOwnerName: tempCreatTaskOwnerName, user: user, userList: userList, visibility: visibility});
																													},
																													A2(
																																					...
																																					return A2(
																																						...
																																						function (createTime) {
																																							return A2(
																																								...
																																								function (commentId) {
																																									return elm$json$Json$Decode$succeed(
																																										{commentId: commentId, createTime: createTime, createdBy: createdBy, taskId: taskId, text: text});
																																								},
																																								A2(elm$json$Json$Decode$field, 'commentId', elm$json$Json$Decode$int));
																																						},
																																						A2(elm$json$Json$Decode$field, 'createTime', elm$json$Json$Decode$string));
																																				},
																																									...
																																									return A2(
																																										...
																																										function (id) {
																																											return A2(
																																												...
																																												function (email) {
																																													return elm$json$Json$Decode$succeed(
																																														{email: email, id: id, imageurl: imageurl, name: name});
																																												},
																					...
																					A2(
																						...
																						A2(
																							...
																							A2(elm$json$Json$Decode$field, 'userPassword', elm$json$Json$Decode$string))));
																			},
																			A2(
																				elm$json$Json$Decode$field,
																				'newTask',
																	...
																	A2(elm$json$Json$Decode$field, 'renderView', elm$json$Json$Decode$string));
															},
															A2(elm$json$Json$Decode$field, 'taskCount', elm$json$Json$Decode$int));
													},
													A2(
														elm$json$Json$Decode$field,
														'taskList',
											...
											A2(elm$json$Json$Decode$field, 'tempCreatTaskOwnerName', elm$json$Json$Decode$string));
									},
									A2(
										elm$json$Json$Decode$field,
										'user',
