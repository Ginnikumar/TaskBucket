package main.java.com.encryptyutils;
...
public class EncryptiUtils
{

    private static String secretKey = "somesecret";

    final static DateFormat formatter = new SimpleDateFormat( "yyyy-MM-dd" );

    private static String salt = formatter.format( new Date() );
